...
sealed class AiDecision2 {
    data class PlayWord(val move: AiMove2) : AiDecision2()
    object ExchangeTiles : AiDecision2()
    object Skip : AiDecision2()
}
...
class AiOpponent2(
    ...
    fun decideMove(
        ...
        if (candidates.isEmpty()) {
            ...
            return if (bagSize >= 7) AiDecision2.ExchangeTiles else AiDecision2.Skip
        }
        ...
        if (best.score < difficulty.exchangeThreshold && bagSize >= 7) {
            return AiDecision2.ExchangeTiles
        }
        ...
        return AiDecision2.PlayWord(chosen)
    }
    ...
    private fun findAllMoves(
        ...
        val moves = mutableListOf<AiMove2>()
    ...
    private fun generateMovesAt(
        ...
        val results = mutableListOf<AiMove2>()
